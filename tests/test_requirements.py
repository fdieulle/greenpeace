...
def test_write_requirements(tmpdir):
    ...
    assert lines[7] == "http://wxpython.org/Phoenix/snapshot-builds/wxPython_Phoenix-3.0.3.dev1820+49a8884-cp34-none-win_amd64.whl\n"
    assert lines[8] == "keyring >= 4.1.1\n"
    assert lines[9] == "numpy > 1.20.0\n"
    assert lines[10] == "pytest\n"
    assert lines[11] == "pytest-cov\n"
    assert lines[12] == "pythonnet @ git+https://github.com/pythonnet/pythonnet@09ecf1b22b9d51691c3da96eb70bf9a615bddb43\n"
